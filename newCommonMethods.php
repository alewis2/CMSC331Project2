...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
	...
	{
		$conn = @mysql_connect("XXXXX", "XXXXX", "XXXXX") or die("<br> Could not connect to MySQL <br>");
		$rs = @mysql_select_db("XXXXXX", $conn) or die("<br> Could not connect to $db database <br>");
		$this->conn = $conn; 
	}
